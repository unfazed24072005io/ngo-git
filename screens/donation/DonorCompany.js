    ...
    <View style={styles.container} key={renderKey}>
      ...
      >
        ...
        <View style={styles.card}>
          ...
          {/* Social Media */}
          {(getField('facebook') || getField('instagram') || getField('twitter') || getField('linkedin') || getField('youtube')) && (
            <View style={styles.socialContainer}>
              {getField('facebook') && getField('facebook') !== translations.notProvided && (
                <TouchableOpacity onPress={() => openLink(getField('facebook'))} style={styles.socialIcon}>
                  <MaterialIcons name="facebook" size={28} color="#1877f2" />
                </TouchableOpacity>
              )}
              {getField('instagram') && getField('instagram') !== translations.notProvided && (
                <TouchableOpacity onPress={() => openLink(getField('instagram'))} style={styles.socialIcon}>
                  <MaterialIcons name="instagram" size={28} color="#e4405f" />
                </TouchableOpacity>
              )}
              {getField('twitter') && getField('twitter') !== translations.notProvided && (
                <TouchableOpacity onPress={() => openLink(getField('twitter'))} style={styles.socialIcon}>
                  <MaterialIcons name="twitter" size={28} color="#1da1f2" />
                </TouchableOpacity>
              )}
              {getField('linkedin') && getField('linkedin') !== translations.notProvided && (
                <TouchableOpacity onPress={() => openLink(getField('linkedin'))} style={styles.socialIcon}>
                  <MaterialIcons name="linkedin" size={28} color="#0a66c2" />
                </TouchableOpacity>
              )}
              {getField('youtube') && getField('youtube') !== translations.notProvided && (
                <TouchableOpacity onPress={() => openLink(getField('youtube'))} style={styles.socialIcon}>
