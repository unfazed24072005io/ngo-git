// screens/member/MemberEvents.js
...
export default function MemberEvents({ navigation }) {
  ...
  const renderKey = `member-events-${counter}`;
      ...
      >
        ...
        {isRegistered && (
          <View style={styles.registeredBadge}>
            ...
            <Text style={styles.registeredBadgeText}>{translations.registeredLabel}</Text>
          </View>
        )}
    ...
    <View style={styles.container} key={renderKey}>
      ...
      <View style={styles.headerCard}>
        ...
        >
          ...
          <StatCard label={translations.registeredLabel} count={registeredEventIds.length} icon="check-circle" color="#ffffff" />
          <StatCard label={translations.ongoing} count={events.filter(e => e.status === 'ongoing').length} icon="play-circle" color="#ffffff" />
        </ScrollView>
      </View>
            ...
            {selectedEvent && (
              <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.detailSection}>
                  ...
                  <Text style={styles.detailValue}>{selectedEvent.location || translations.nA}</Text>
                </View>
