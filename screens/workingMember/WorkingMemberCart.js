// screens/workingMember/WorkingMemberCart.js
...
export default function WorkingMemberCart({ navigation, route }) {
  ...
  const renderKey = `working-cart-${counter}`;
  ...
  const translations = {
    ...
    cart: t('ecommerce.title') || 'E-Commerce',
  };
    ...
    <View style={styles.container} key={renderKey}>
      ...
      <View style={styles.headerCard}>
        <View style={styles.headerTop}>
          ...
          <Text style={styles.itemCount}>{getTotalItems()} {translations.items}</Text>
        </View>
      </View>
        ...
        <>
          ...
          <View style={styles.bottomContainer}>
            <View style={styles.summaryRow}>
              <Text style={styles.summaryLabel}>{translations.subtotal} ({getTotalItems()} {translations.items})</Text>
