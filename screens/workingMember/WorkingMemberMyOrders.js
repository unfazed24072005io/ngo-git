// screens/workingMember/WorkingMemberMyOrders.js
import React, { useState, useEffect } from 'react';
import { View, Text, StyleSheet, ScrollView, TouchableOpacity, Alert, Image, ActivityIndicator, RefreshControl, FlatList, Modal, Linking, Share } from 'react-native';
...
export default function WorkingMemberMyOrders({ navigation }) {
  ...
  const renderKey = `working-myorders-${counter}`;
  ...
  const translations = {
    ...
    statusProcessing: t('orders.processing') || 'processing',
    statusCompleted: t('orders.completed') || 'completed',
